...
public final class ActivityStatsBinding implements ViewBinding {
  ...
  private ActivityStatsBinding(@NonNull RelativeLayout rootView, @NonNull Button btnBack,
      @NonNull TextView statsView) {
  ...
  public static ActivityStatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.statsView;
      TextView statsView = ViewBindings.findChildViewById(rootView, id);
      if (statsView == null) {
        break missingId;
      }

      return new ActivityStatsBinding((RelativeLayout) rootView, btnBack, statsView);
    }
